...
Every operation is a method on the client. Every constructor argument is optional and keyword-only. Sources: `coin_gecko/client.py`, `coin_gecko/async_client.py`:
...
## Operations — by controller (1 page, 61 operations)
...
| Controller | Ops | Page |
| --- | --- | --- |
| `client` (root) | 61 | [map/operations/client.md](map/operations/client.md) |

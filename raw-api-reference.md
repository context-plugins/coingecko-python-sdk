...
```python
result = client.with_raw_response.asset_platforms_list()
match result:
...
```python
result = await async_client.with_raw_response.asset_platforms_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[AssetPlatform]
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_categories()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_categories()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[Category1]
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_categories_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_categories_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CategoriesList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsContractAddress
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_id()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsId
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id_history()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_id_history()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsIdHistory
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id_market_chart()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_id_market_chart()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id_market_chart_range()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.coins_id_market_chart_range()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id_ohlc(days)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_id_ohlc(days)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[list[float]]
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_id_tickers()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_id_tickers()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsIdTickers
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CoinsList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.coins_markets()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.coins_markets()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[CoinsMarket]
    case Failure(error=error):
...
```python
result = client.with_raw_response.companies_public_treasury(entity)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.companies_public_treasury(entity)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PublicTreasury
    case Failure(error=error):
...
```python
result = client.with_raw_response.contract_address_market_chart()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.contract_address_market_chart()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = client.with_raw_response.contract_address_market_chart_range()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.contract_address_market_chart_range()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsMarketChart
    case Failure(error=error):
...
```python
result = client.with_raw_response.crypto_global()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.crypto_global()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type GlobalModel
    case Failure(error=error):
...
```python
result = client.with_raw_response.derivatives_exchanges()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.derivatives_exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[DerivativesExchange]
    case Failure(error=error):
...
```python
result = client.with_raw_response.derivatives_exchanges_id()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.derivatives_exchanges_id()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type DerivativesExchangesId
    case Failure(error=error):
...
```python
result = client.with_raw_response.derivatives_exchanges_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.derivatives_exchanges_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[DerivativesExchangesList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.derivatives_tickers()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.derivatives_tickers()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[DerivativesTicker]
    case Failure(error=error):
...
```python
result = client.with_raw_response.dexes_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.dexes_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type DexesList
    case Failure(error=error):
...
```python
result = client.with_raw_response.entities_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.entities_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[EntitiesList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchange_rates()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.exchange_rates()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type ExchangeRates
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchanges()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.exchanges()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[Exchange1]
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchanges_id()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.exchanges_id()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type ExchangesId
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchanges_id_tickers()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsIdTickers
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.exchanges_id_tickers()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type CoinsIdTickers
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchanges_id_volume_chart(days)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.exchanges_id_volume_chart(days)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[list[ExchangeVolumeChart]]
    case Failure(error=error):
...
```python
result = client.with_raw_response.exchanges_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.exchanges_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[ExchangesList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.global_defi()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.global_defi()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type GlobalDeFi
    case Failure(error=error):
...
```python
result = client.with_raw_response.latest_pools_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.latest_pools_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.latest_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.latest_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.networks_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.networks_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type NetworksList
    case Failure(error=error):
...
```python
result = client.with_raw_response.nfts_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.nfts_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Nftdata
    case Failure(error=error):
...
```python
result = client.with_raw_response.nfts_id()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Nftdata
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.nfts_id()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Nftdata
    case Failure(error=error):
...
```python
result = client.with_raw_response.nfts_list()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.nfts_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[NftsList]
    case Failure(error=error):
...
```python
result = client.with_raw_response.onchain_simple_price()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.onchain_simple_price()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type OnchainSimplePrice
    case Failure(error=error):
...
```python
result = client.with_raw_response.ping_server()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.ping_server()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PingServer
    case Failure(error=error):
...
```python
result = client.with_raw_response.pool_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pool_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PoolAddressData
    case Failure(error=error):
...
```python
result = client.with_raw_response.pool_ohlcv_contract_address(timeframe)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pool_ohlcv_contract_address(timeframe)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Ohlcv
    case Failure(error=error):
...
```python
result = client.with_raw_response.pool_token_info_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pool_token_info_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PoolTokensInfo
    case Failure(error=error):
...
```python
result = client.with_raw_response.pool_trades_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pool_trades_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Trades
    case Failure(error=error):
...
```python
result = client.with_raw_response.pools_addresses()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.pools_addresses()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MultiPoolAddressData
    case Failure(error=error):
...
```python
result = client.with_raw_response.public_treasury_entity()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.public_treasury_entity()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PublicTreasuryEntity
    case Failure(error=error):
...
```python
result = client.with_raw_response.public_treasury_entity_chart()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.public_treasury_entity_chart()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PublicTreasuryEntityChart
    case Failure(error=error):
...
```python
result = client.with_raw_response.public_treasury_transaction_history()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.public_treasury_transaction_history()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PublicTreasuryTransactionHistory
    case Failure(error=error):
...
```python
result = client.with_raw_response.search_data(query)
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.search_data(query)
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Search
    case Failure(error=error):
...
```python
result = client.with_raw_response.search_pools()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.search_pools()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type PoolSearch
    case Failure(error=error):
...
```python
result = client.with_raw_response.simple_price()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.simple_price()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type dict[str, SimplePrice]
    case Failure(error=error):
...
```python
result = client.with_raw_response.simple_supported_currencies()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.simple_supported_currencies()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type list[str]
    case Failure(error=error):
...
```python
result = client.with_raw_response.simple_token_price()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type dict[str, SimplePrice]
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.simple_token_price()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type dict[str, SimplePrice]
    case Failure(error=error):
...
```python
result = client.with_raw_response.token_data_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.token_data_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TokenData
    case Failure(error=error):
...
```python
result = client.with_raw_response.token_info_contract_address()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.token_info_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TokenInfo
    case Failure(error=error):
...
```python
result = client.with_raw_response.token_lists()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.token_lists()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TokenLists
    case Failure(error=error):
...
```python
result = client.with_raw_response.tokens_data_contract_addresses()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.tokens_data_contract_addresses()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type MultiTokenData
    case Failure(error=error):
...
```python
result = client.with_raw_response.tokens_info_recent_updated()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.tokens_info_recent_updated()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TokenInfoRecentlyUpdated
    case Failure(error=error):
...
```python
result = client.with_raw_response.top_pools_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.top_pools_contract_address()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.top_pools_dex()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.top_pools_dex()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.top_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.top_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.trending_pools_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.trending_pools_list()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.trending_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = await async_client.with_raw_response.trending_pools_network()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type Pool
    case Failure(error=error):
...
```python
result = client.with_raw_response.trending_search()
match result:
    case Success(payload=payload):
...
```python
result = await async_client.with_raw_response.trending_search()
match result:
    case Success(payload=payload):
        ...  # TODO: Handle 'payload' of type TrendingSearch
    case Failure(error=error):
